...
function onInit()
	...
	maxammonode = window.getDatabaseNode().createChild("npcpowerlevel", "number");
...
function adjustCounter(nAdj)
	...
	window.psy_npcpsyusedinvcounter.setValue(c);
end
...
function getMaxValue()
	return DB.getValue(window.getDatabaseNode(), "npcpowerlevel", 0);
end
